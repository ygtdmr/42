...
/*   Updated: 2026/07/01 20:16:38 by yidemir          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Config
{
	...
	private:
		...
		void validateServer( config::Server const& server ) const;
		void validateLocation( config::Server const& server, std::string const& locationPath ) const;
